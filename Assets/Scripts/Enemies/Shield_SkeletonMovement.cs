...
public class Shield_SkeletonMovement : MonoBehaviour
{

    public Animator animator;
    //public Transform transform;
    //public BoxCollider2D playerInRangeCollider;
    //public BoxCollider2D playerInAttackRangeCollider;
    ...
    void Update()
    {
        ...
        if (!isDead)
        {
            ...
            else if (canBlock && playerInAttackRange && !isAttack)
            {
                //blocking handler
                canBlock = false;
                Invoke("resetBlock", blockDelay);
